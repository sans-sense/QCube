describe("QueryEngine", function() {
    ...
    it('for *,*,* should give a sum of all table data i.e 27, root works', function(){
        var total, row;
        total = 0;
    ...
    it('for S1, P1, * should give sum of all records with S1 and P1 i.e. 6, searchRoute last child logic' , function() {
        expect(QE.find(this.qcTree, ['S1', 'P1', '*'])).toEqual(6);
    });

    it('for S1, *, * should give sum of all records with S1  i.e. 18, pick last dim child logic' , function() {
